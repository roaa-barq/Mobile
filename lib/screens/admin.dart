    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        children: [
              ...
              child: Center(
                child: FlatButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => gpsAdmin()),
                    );
                  },
                  child: Container(
                      decoration: BoxDecoration(
          ...
          Padding(
            padding: EdgeInsets.only(top: 1920),
            child: Column(
              children: [
                Center(
                  child: Container(
          ...
          Padding(
            padding: EdgeInsets.fromLTRB(15, 2050, 15, 0),
          ...
          Padding(
              padding: EdgeInsets.fromLTRB(0, 2100, 100, 0),
          ...
          Padding(
              padding: EdgeInsets.only(top: 2180),
              child: Container(
                color: greenDark,
                height: 170,
